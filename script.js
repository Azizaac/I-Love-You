document.addEventListener('DOMContentLoaded', () => {
  const blupAudio = document.querySelector('.blup');
  const blopAudio = document.querySelector('.blop');
  ...
  soundButton.addEventListener('click', () => {
      playSound(blupAudio); // Play the blup sound
  });


  if (typeof mojs === 'undefined') {
    console.error('mojs is not defined. Please ensure the library is loaded.');
    return;
  }
